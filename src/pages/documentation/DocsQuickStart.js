        ...
        <Card>
          <Card.Body>
            <article>
              ...
              <p className="fs-5 fw-light">This guide will help you get started with Trashnet Dashboard</p>

              <p>
                <b>Trashnet Dashboard</b> is built on top of <Card.Link href="https://react-bootstrap.github.io/" target="_blank">React Bootstrap</Card.Link> using <a href="https://github.com/facebook/create-react-app/" target="_blank" rel="noopener noreferrer">Create React App</a>.
              </p>
