        ...
        <Card>
          <Card.Body>
            <article>
              ...
              <p className="fs-5 fw-light">Download files for Trashnet Dashboard</p>

              <p>Trashnet Dashboard is a React.js and Bootstrap 5 powered admin dashboard template featuring components, pages and plugins that you can use to create an awesome and interactive admin interface.</p>
